<template>
  <div class="app-container test-component">
    <card-panel header="dynamic-ui">
      ...
      <el-button @click="changeTestVal('changeVal')">改变值</el-button>
    </card-panel>

    <card-panel header="jl-ui">
      <jl-input
        ref="dynamicInput"
        v-model.lazy="testVal"
        is-autocomplete
...
<script>
// import dynamicInput from '@/components/common/dy-input'
export default {
  name: 'CkTestInput',
  components: {
    // 'dy-input': dynamicInput
  },
  data() {
    return {
      testType: 'text',
  ...
  methods: {
    ...
    getInputFocus() {
      // console.log(this.$refs.dynamicInput.$refs['child-input'], '-->')
      const {
        dynamicInput
      } = this.$refs
